      ...
      <>
        ...
        <main className="flex flex-1 flex-col items-center justify-center gap-3 p-8 text-center">
          <p className="max-w-md text-sm text-muted-foreground">
            Selecione um estagiário para ver o histórico. Acesse{' '}
            <strong>Administração → Usuários</strong> e use o link de histórico, ou adicione{' '}
            <code className="rounded bg-muted px-1">?userId=</code> na URL.
          </p>
        </main>
      </>
    )
