    ...
    <main className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12 text-white">
          {/* Logo */}
          <div className={`flex items-center gap-3 mb-auto pt-8 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-5'}`}>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            <h1 className={`text-4xl font-bold mb-4 transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
              Bem-vindo de volta!
            </h1>
            <p className={`text-white/80 max-w-xs mb-8 transition-all duration-700 delay-300 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
              Para continuar conectado conosco, faça login com suas credenciais pessoais
            </p>
            
            {/* Informações de teste */}
            <div className={`bg-white/10 backdrop-blur-sm rounded-xl p-4 text-sm transition-all duration-700 delay-400 ${mounted ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
              <p className="font-medium mb-2">Credenciais de teste:</p>
              <div className="space-y-1 text-white/90 text-left">
                <p><span className="text-white/60">Admin:</span> admin@empresa.com / admin123</p>
                <p><span className="text-white/60">Estagiário:</span> estagiario@empresa.com / est123</p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className={`w-full max-w-md transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
          {/* Logo mobile */}
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-black mb-2">Entrar na Conta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <FieldGroup>
              ...
              <Field>
                <FieldLabel htmlFor="senha" className="text-gray-700">Senha</FieldLabel>
                <div className="relative group">
          ...
          <div className="lg:hidden mt-8 p-4 rounded-xl bg-muted/50 border border-border">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <p className="text-center"><strong>Admin:</strong> admin@empresa.com / admin123</p>
              <p className="text-center"><strong>Estagiário:</strong> estagiario@empresa.com / est123</p>
            </div>
          </div>
        </div>
      </div>
