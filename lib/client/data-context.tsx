...
import { runVoidAction } from '@/lib/data/data-action-utils'
import { isPresencaBloqueada as checkPresencaBloqueada } from '@/lib/domain/ponto/presenca-bloqueio'
import {
...
} from '@/lib/domain/ponto/banco-horas'
    ...
    (usuario: Omit<User, 'id' | 'createdAt' | 'cargaHorariaSemanal'> & {
      ...
      void runVoidAction(
        createUsuarioAction({
          ...
          horarioTrabalhoSaida1: usuario.horarioTrabalhoSaida1,
          horarioTrabalhoEntrada2: usuario.horarioTrabalhoEntrada2,
          horarioTrabalhoSaida2: usuario.horarioTrabalhoSaida2,
        }),
        () => refreshData(),
